...
def calculadora_rapida():
        #definir variaveis
        c = float(calculadora_c.place()) if calculador_c.get() else 0.0
        imp = float(calculadora_imp.get()) if calculadora_imp.get() else 0.0
        dig = float(calculadora_dig.get()) if calculadora_dig.get() else 0.0
        ...
        label_calculadora.config(text=f"CALCULADORA RÁPIDA/n/n Cópias:/n Impressões:/n Digitalização:/n ")
        window.after(500, atualizar_relacao_paginas) #atualiza em cada 500 milissegundos (meio segundo)
...
tk.Label(window, text="Perdidas Cóp:", bg="light blue", font=font_padrao).grid(row=1, column=2, sticky="e", padx=2, pady=5)
...
tk.Label(window, text="Perdidas IK:", bg="light blue", font=font_padrao).grid(row=2, column=2, sticky="e", padx=2, pady=5)
...
tk.Label(window, text="Perdidas IB:", bg="lightblue", font=font_padrao).grid(row=3, column=2, sticky="e", padx=2, pady=5)
...
tk.Label(window, text="Perdidas Dig:", bg="light blue", font=font_padrao).grid(row=4, column=2, sticky="e", padx=2, pady=5)
...
label_calculadora_c = tk.Label(window, text="Cópias:", font=("arial", 12, "bold"))
calculadora_c = tk.Entry(window, font=font_padrao, bg="white")
calculadora_c.place(x=1050, y=90, width=50, height=30)
